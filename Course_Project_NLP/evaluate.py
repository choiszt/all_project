...
from applications.sentiment_analysis.unified_sentiment_extraction.nlp课设.utils import (
    convert_example,
    create_data_loader,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", choices=["uie-senta-micro", "uie-senta-medium", "uie-senta-mini", "uie-senta-micro", "uie-senta-nano"], default="uie-senta-mini", type=str, help="Select the pretrained model for few-shot learning.")
    args = parser.parse_args()
    # yapf: enable
    # args.model_path="/mnt/ve_share/liushuai/PaddleNLP/applications/sentiment_analysis/unified_sentiment_extraction/liushuai_workdir/results/micro/model_best"
    # args.model_path="/mnt/ve_share/liushuai/PaddleNLP/applications/sentiment_analysis/unified_sentiment_extraction/liushuai_workdir/model_6"
    
    args.model_path="/mnt/ve_share/liushuai/PaddleNLP/applications/sentiment_analysis/unified_sentiment_extraction/liushuai_workdir/results/mini/model_best"
    args.test_path="/mnt/ve_share/liushuai/PaddleNLP/applications/sentiment_analysis/unified_sentiment_extraction/Data/json/test.json"
    do_eval()
