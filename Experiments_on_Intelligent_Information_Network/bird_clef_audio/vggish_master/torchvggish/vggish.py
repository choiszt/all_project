...
class VGGish(VGG):
    def __init__(self, urls,device=None, pretrained=False, preprocess=False, postprocess=False, progress=True):
        super().__init__(make_layers())
        if pretrained:
            state_dict = hub.load_state_dict_from_url(urls['vggish'], progress=progress)
            print('urls',urls['vggish'])
            print(state_dict)
