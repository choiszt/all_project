...
class VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        #     elif i == 15:
        #         Layer15_out = x
        # print('Layer0_out',Layer0_out.shape)
        ...
        # print('Layer10_out',Layer10_out.shape)
        # print('Layer11_out',Layer11_out.shape)
        # print('Layer13_out',Layer13_out.shape)
        # print('Layer15_out',Layer15_out.shape)


        x = self.features(x)
        print('self.features',self.features)
        print(len(self.features))
        print('获取feature后的维度：',x.shape)
        ...
        #     if i == 4:
        #         Linear3_out = x
        # print('Linear1_out',Linear1_out.shape)
        # print('Linear2_out',Linear2_out.shape)
        # print('Linear3_out',Linear3_out.shape)
...
class VGGish(VGG):
    def __init__(self, urls, device=None, pretrained=False, preprocess=True, postprocess=False, progress=True):
    ...
    def forward(self, x, fs=None):
        ...
        print('vggish',x.shape)
        if self.postprocess:
            x = self._postprocess(x)
        print('最后输出的维度',x.shape)
        return x
