	...
	case SW is 
		...
		when "000" => -- fetch instruction
			if (ST0 = '0') then
				...
				LIR <= ((((NOT IR(7)) AND (NOT IR(6)))
				OR ((NOT C) AND (NOT IR(7)) AND IR(6) AND IR(5) AND IR(4))
				OR ((NOT Z) AND IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND (NOT IR(4)))) AND W(1))
				OR (((IR(6) AND (NOT IR(5)))
				OR (IR(6) AND (NOT IR(4)))
				OR (IR(7) AND IR(4))
				OR (C AND (NOT IR(7)) AND IR(6) AND IR(5) AND IR(4))
				OR ((Z AND IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND (NOT IR(4))))) AND W(2));
				
				PCINC <= ((((NOT IR(7)) AND (NOT IR(6)))
				OR ((NOT C) AND (NOT IR(7)) AND IR(6) AND IR(5) AND IR(4))
				OR ((NOT Z) AND IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND (NOT IR(4)))) AND W(1))
				OR (((IR(6) AND (NOT IR(5)))
				OR (IR(6) AND (NOT IR(4)))
				...
				S(3) <= (((IR(6) AND IR(5) AND (NOT IR(4)))
				OR ((NOT IR(6)) AND IR(4))
				OR ((NOT IR(5)) AND IR(4))) AND W(1))
				OR ((((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4)))) AND W(2));
				
				S(2) <= (((NOT IR(7)) AND IR(5) AND (NOT IR(4)))
				OR (IR(7) AND IR(4))) AND W(1);
				
				S(1) <= ((((NOT IR(6)) AND IR(5) AND IR(4))
				OR ((NOT IR(7)) AND IR(5) AND (NOT IR(4)))
				OR (IR(6) AND (NOT IR(5)) AND IR(4))
				OR (IR(7) AND IR(4))) AND W(1))
				OR (((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4))) AND W(2));
				
				S(0) <= ((IR(6) AND IR(5) AND (NOT IR(4))) 
				OR ((NOT IR(6)) AND IR(4))) AND W(1);
				
				CIN <= ((NOT IR(7)) AND (NOT IR(6)) AND (NOT IR(5)) AND IR(4)) AND W(1);
				
				ABUS <= ((((NOT IR(7)) AND IR(5) AND (NOT IR(4))) 
				OR ((NOT IR(6)) AND IR(4)) 
				OR (IR(6) AND (NOT IR(5)))) AND W(1)) 
				OR (((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4))) AND W(2));
				
				DRW <= ((((NOT IR(7)) AND (NOT IR(6)) AND IR(4)) 
				OR ((NOT IR(7)) AND (NOT IR(6)) AND IR(5))
				OR (IR(6) AND (NOT IR(5)) AND (NOT IR(4)))) AND W(1)) 
				OR (((NOT IR(7)) AND IR(6) AND (NOT IR(5)) AND IR(4)) AND W(2));
				...
				OR ((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4)))) AND W(1);
			
				MBUS <= ((NOT IR(7)) AND IR(6) AND (NOT IR(5)) AND IR(4)) AND W(2);
				
				MEMW <= ((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4))) AND W(2);
				
				
				PCADD <= ((C AND ((NOT IR(7)) AND IR(6) AND IR(5) AND IR(4))) 
				OR (Z AND (IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND (NOT IR(4))))) AND W(1);
				
				STOP <= (IR(7) AND (NOT IR(6)) AND IR(5) AND (NOT IR(4))) AND W(1);
				
				M <= ((((NOT IR(6)) AND IR(5) AND IR(4))
				OR (IR(6) AND (NOT IR(5)) AND IR(4))
				OR (IR(6) AND IR(5) AND (NOT IR(4)))
				OR (IR(7) AND IR(4))) AND W(1))
				OR (((NOT IR(7)) AND IR(6) AND IR(5) AND (NOT IR(4))) AND W(2));
				
				LPC <= (IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND IR(4)) AND W(1);
				
				SHORT <= (((NOT IR(7)) AND (NOT IR(6)))
					OR ((NOT IR(6)) AND IR(5))
					OR ((NOT C) AND (NOT IR(7)) AND IR(6) AND IR(5) AND IR(4))
					OR ((NOT Z) AND IR(7) AND (NOT IR(6)) AND (NOT IR(5)) AND (NOT IR(4)))) AND W(1);
