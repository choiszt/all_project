...
parser.add_argument('--output_file', type=str, default='./origin_gsm8k_test.txt', help='Output file for claude-instant')
...
def load():
    state_dict = "/mnt/ve_share/liushuai/nndl/FlagAI-master/examples/Aquila/Aquila-chat/checkpoints_out/choiszt/2023070702"
